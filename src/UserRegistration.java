...
public class UserRegistration {
    ...
    public void registration() {
        ...
        System.out.print("Please enter your card number.(Only Visa, MasterCard, and American Express cards are accepted): ");
        ...
        System.out.print("Please enter your card expiry date: ");
    ...
    private void chargeFees() {
        if (minorAndBirthday) {
            feeToCharge = VIP_BASE_FEE - (VIP_BASE_FEE * (VIP_DISCOUNT_UNDER_18_BIRTHDAY / 100.0));
        } else if (minor) {
            feeToCharge = VIP_BASE_FEE - (VIP_BASE_FEE * (VIP_DISCOUNT_UNDER_18 / 100.0));
        } else {
    ...
    public String toString() {
        ...
        String result = "Registration successful! Here are your details:\n";
        result += "User Type: " + userType + "\n";
        result += "Full Name: " + fullName + "\n";
        result += "Email Address: " + emailAddress + "\n";
        result += "Date of Birth: " + dateOfBirth + "\n";
        result += "Card Number: " + censoredNumber + "\n";
        result += "Card Provider: " + cardProvider + "\n";
        result += "Card Expiry Date: " + cardExpiryDate + "\n";
